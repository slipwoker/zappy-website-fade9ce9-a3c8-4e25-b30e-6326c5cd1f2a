document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showError(input, message) {
            ...
            error.style.cssText = 'color: #e53e3e; font-size: 0.875rem; margin-top: 0.25rem; display: block;';
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const label = input.closest('label')?.textContent || name || 'This field';
    ...
    if (animatedElements.length > 0) {
        ...
        // Add CSS rule for visible state if not already present
        if (!document.querySelector('#scroll-animation-styles')) {
            const style = document.createElement('style');
            style.id = 'scroll-animation-styles';
            style.textContent = `
                .fade-in.visible, .animate-on-scroll.visible, [data-animate].visible {
                    opacity: 1 !important;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fade9ce9-a3c8-4e25-b30e-6326c5cd1f2a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fade9ce9-a3c8-4e25-b30e-6326c5cd1f2a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fade9ce9-a3c8-4e25-b30e-6326c5cd1f2a';
